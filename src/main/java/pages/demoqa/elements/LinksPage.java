...
public class LinksPage extends BasePage {
     ...
     */
    private static final String LINKS_PAGE_URL = "https://demoqa.com/links";
     ...
     */
    private static final By BANNER_XPATH = By.xpath("//img[@class='banner-image']");

    /**
     * Локатор до строки со статус кодом
     */
    private static final String STATUS_XPATH = "//b[text()='%s']";

    /**
     * Локатор до ссылки с вызовом метода
     */
    private static final String NAME_XPATH = "//a[@id='%s']";
    ...
    public boolean isStatusDisplay(String status){
        new WebDriverWait(driver, Duration.ofSeconds(3)).until
                (d -> isElementDisplay(By.xpath(String.format(STATUS_XPATH, status))));
