...
public class RadioButtonPage extends BasePage {
     ...
     */
    private static final String URL_TEXT_BOX_PAGE = "https://demoqa.com/radio-button";

    /**
     * Локатор до радио баттонов
     */
    private static final String RADIO_BUTTON_XPATH = "//input[@type='radio']" +
            "[following-sibling::label[contains(., '%s')]]";
    private static final String RADIO_BUTTON_CLICK_XPATH = "//input[@type='radio']" +
            "/following-sibling::label[contains(., '%s')]";
